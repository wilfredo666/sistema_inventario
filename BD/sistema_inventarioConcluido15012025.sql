...
-- Tiempo de generación: 15-01-2025 a las 05:56:17
...
CREATE TABLE `nota_empaque` (
  ...
  `nro_comprobante_emp` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
...
(2, 1, '2025-01-13', 'IE-10002', '', '[{\"idProducto\":\"2\",\"descProducto\":\"Media Pantalon Lujo CP - Tabaco\",\"costoProducto\":35,\"cantProdDocena\":\"5\",\"cantProdUnidad\":\"4\"}]', 0, 0, 1),
(3, 1, '2025-01-13', 'IE-10003', '', '[{\"idProducto\":\"4\",\"descProducto\":\"Media Pantalon Lujo CP - Calipso\",\"costoProducto\":55,\"cantProdDocena\":\"15\",\"cantProdUnidad\":\"5\"},{\"idProducto\":\"5\",\"descProducto\":\"Media Pantalon Lujo CP - Acacia\",\"costoProducto\":28,\"cantProdDocena\":\"12\",\"cantProdUnidad\":\"6\"}]', 0, 0, 1);
...
CREATE TABLE `nota_ingreso_ajuste` (
  ...
  `nro_comprobante_ajuste` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
...
--
-- Volcado de datos para la tabla `nota_ingreso_ajuste`
--

INSERT INTO `nota_ingreso_ajuste` (`id_ingreso_ajuste`, `id_personal`, `fecha_ingreso_ajuste`, `nro_comprobante_ajuste`, `observacion_ingreso_ajuste`, `detalle_ingreso_ajuste`, `estado_ingreso_ajuste`) VALUES
(1, 1, '2025-01-13', 'IA-1', '', '[{\"idProducto\":\"5\",\"descProducto\":\"Media Pantalon Lujo CP - Acacia\",\"costoProducto\":null,\"cantProdDocena\":\"2\",\"cantProdUnidad\":\"4\"}]', 1);
...
CREATE TABLE `nota_ingreso_prov` (
  ...
  `nro_comprobante_prov` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
...
(2, 'ASATEX', '2025-01-13', 'IP-2', '', '[{\"idProducto\":\"5\",\"descProducto\":\"Media Pantalon Lujo CP - Acacia\",\"costoProducto\":80,\"cantProdDocena\":\"6\",\"cantProdUnidad\":\"8\"}]', 1);
...
CREATE TABLE `nota_otros_ingresos` (
  ...
  `nro_comprobante_otros` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
...
--
-- Volcado de datos para la tabla `nota_otros_ingresos`
--

INSERT INTO `nota_otros_ingresos` (`id_otros_ingresos`, `id_personal`, `fecha_otros_ingresos`, `nro_comprobante_otros`, `observacion_otros_ingresos`, `detalle_otros_ingresos`, `estado_otros_ingresos`) VALUES
(1, 1, '2025-01-13', 'OI-1', '', '[{\"idProducto\":\"5\",\"descProducto\":\"Media Pantalon Lujo CP - Acacia\",\"costoProducto\":null,\"cantProdDocena\":\"6\",\"cantProdUnidad\":\"2\"}]', 1);
...
(15, 'SO-3', 'null', '[{\"idProducto\":\"1\",\"descProducto\":\"Media Pantalon Lujo CP - Cognac\",\"costoProducto\":25,\"cantProdDocena\":\"2\",\"cantProdUnidad\":\"0\",\"descuentoCliente\":\"0\"}]', '50.00', '0.00', '50.00', '2025-01-13', '', 1, 'Promocion', 1),
(16, 'SO-4', 'null', '[{\"idProducto\":\"1\",\"descProducto\":\"Media Pantalon Lujo CP - Cognac\",\"costoProducto\":25,\"cantProdDocena\":\"2\",\"cantProdUnidad\":\"0\",\"descuentoCliente\":\"0\"}]', '50.00', '0.00', '50.00', '2025-01-13', '', 1, 'Promocion', 1);
...
(10, 'ELISEO AMARU', 'eliseo', '$2y$10$x4DyAumv/gNDbjvRoifJIebNXY33OfQUKOAGfMxJHQIGqH9PvSEJ.', 'Auxiliar', '0000-00-00 00:00:00', '2025-01-14', 0);
...
CREATE TABLE `venta` (
  ...
  `codigo_venta` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
  `id_cliente` int(11) NOT NULL,
...
--
ALTER TABLE `ingreso_stock`
  MODIFY `id_ingreso_stock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `nota_empaque`
  MODIFY `id_nota_empaque` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `nota_ingreso_ajuste`
  MODIFY `id_ingreso_ajuste` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `nota_ingreso_prov`
--
ALTER TABLE `nota_ingreso_prov`
  MODIFY `id_ingreso_prov` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `nota_otros_ingresos`
--
ALTER TABLE `nota_otros_ingresos`
  MODIFY `id_otros_ingresos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `nota_salida_otros`
  MODIFY `id_salida_otros` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `salida_stock`
  MODIFY `id_salida_stock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
