<div class="content-wrapper">
    <section class="content-header text-center pt-1 mt-1 pb-1 mb-1">
        <h4 class="align-item-center pt-0 mt-0 pb-0 mb-0 bg-dark">NOTA DE INGRESO POR AJUSTE DE INVENTARIOS</h4>
    </section>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card card-success card-outline">
                        <div class="card-header" style="background-color: #48E3A4;">
                        ...
                        <div class="card-body row pb-2 mb-2">
                            ...
                            <div class="col-md-8">
                                <!-- <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="personal" id="personal" placeholder="Personal Encargado del ajuste de Inv.">
                                </div> -->
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    $item = null;
                                    $valor = null;
                                    $registros = ControladorProducto::ctrMostrarIngAjuste();

                                    if ($registros == 0) {
                                        echo '<input type="text" class="form-control" id="nroComprobante" name="nroComprobante" value="IA-1" readonly>';
                                    } else {
                                        $notaRegistro = ControladorProducto::ctrMostrarUltimaNIA();
                                        $codigo = $notaRegistro["nro_comprobante_ajuste"];
                                        $dividirCodigo = explode("-", $codigo);
                                        $numeroCorrelativo = $dividirCodigo[1] + 1;

                                        echo '<input type="text" class="form-control" id="nroComprobante" name="nroComprobante" value="IA-' . $numeroCorrelativo . '" readonly>';
                                    }
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="card-footer text-right">
                            ...
                            <a class="btn btn-success" onclick="GuardarNotaIngAjuste()"><i class="fas fa-download"></i> Guardar Nota</a>
                        </div>
                    </div>
                </div>
