<div class="content-wrapper">
    <section class="content-header text-center pt-1 mt-1 pb-1 mb-1">
        <h4 class="align-item-center pt-0 mt-0 pb-0 mb-0 bg-dark">NOTA DE SALIDA POR VENTA</h4>
    </section>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card card-success card-outline">
                        ...
                        <div class="card-footer text-right">
                            ...
                            <a class="btn btn-primary" onclick="GuardarNotaVenta()"><i class="fas fa-download"></i> Guardar Nota</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body row pb-0 mb-0">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="descuentoCliente" id="descuentoCliente" placeholder="0">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <!-- </div> -->
                        <div class="card-footer text-right">
                            <button type="button" class="btn btn-dark" onclick="agregarCarritoNV()"><i class="fas fa-plus-circle"></i> Agregar Item</button>
                        </div>
                    </div>
                </div>
            </div>
