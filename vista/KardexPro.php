...
$spreadsheet->getProperties()->setCreator("Wilfredo Saez")->setTitle("Reporte_Productos");
...
$sheet->setCellValue('A3', 'Periodo: 12 DIC 2024 00:00:00 AL 6 ENE 2025 23:59:59');
$sheet->getStyle('A3')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);


// Información del producto
$sheet->mergeCells('A4:E4');
$sheet->setCellValue('A4', 'Código de Producto: MN001 - MEDIA PANTALON LUJO');
