...
//capturando valores por get de RNotaIngreso.php
$codigo=$_GET["cod"];
$id=$_GET["id"];
...
$pdf->Cell(95, 3, 'NOTA DE INGRESO', 0, 1, 'C');
$pdf->SetFont('Arial', '', 11);
$pdf->Cell(55, 10, 'La Paz - Bolivia', 0, 1, 'C');
$pdf->Cell(70, 5, '', 0, 1);

//$pdf->Cell(140, 8, 'Nombre: ' . " " . $notaIngreso['observacion'], 0, 0);
$pdf->Cell(70, 8, 'Nota:' . " " . $notaIngreso['codigo'], 0, 1);
$pdf->Multicell(140, 5, utf8_decode('Observación:') . " " . utf8_decode($notaIngreso['observacion']), 0, 0);
$pdf->SetFont('Arial', '', 11);
$pdf->setY(45);
$pdf->setX(150);
$pdf->Cell(70, 5, 'Fecha: ' . " " . $notaIngreso['fecha'], 0, 1);
$pdf->Cell(70, 5, '', 0, 1);
$pdf->Cell(70, 5, '', 0, 1);
