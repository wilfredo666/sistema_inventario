...
function dibujarTablaCarritoNE() {
  ...
  var productoEmpaque = document.getElementById("productoEmpaque").value;
  ...
  arregloCarritoNE.forEach((detalle) => {
    ...
    fila.innerHTML = '<td>' + productoEmpaque + '</td>' +

      '<td><input type="number" class="form-control form-control-sm" id="cantProDocena_' + detalle.idProducto + '" value="' + ingDocenas + '" onkeyup="actCantidadNE(' + detalle.idProducto + ')">'  + '</td>'+
      
      '<td><input type="number" class="form-control form-control-sm" id="cantProV_' + detalle.idProducto + '" value="' + ingUnidades + '" onkeyup="actCantidadDocNE(' + detalle.idProducto + ')">'  + '</td>'+
      
      '<td><input type="number" class="form-control form-control-sm" id="costoProV_' + detalle.idProducto + '" value="' + costoProducto + '">'  + '</td>'+
